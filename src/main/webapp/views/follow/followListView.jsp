	...
	<div class="bd-example container" style="width:70%;">
        ...
        <table class="table table-hover">
          ...
          <tr class="table-secondary">
            ...
            <th scope="col" style="text-align: left;">여부</th>
          </tr>
          </thead>
          <tbody>
          <%if(list.isEmpty()){ %>
          ...
          <% }for(Member m : list){ %>
          <tr>
            <th scope="row"><img src="/fm/resources/images/<%= m.getProfilePic()!=null?m.getProfilePic():"user.png" %>" 
					style="width: 20px;height: 20px;object-fit: cover;border-radius:50%;">&nbsp;<a href="/fm/info?mid=<%=m.getmId()%>" style="font-weight: normal;text-decoration: none;color:black;"><%= m.getEmail() %></a></th>
            <td style="text-align: left;"><%= m.getFollowtime() %></td>
            <td style="text-align: left;">
	    <a onclick="followdelete('<%= m.getmId() %>');" style="font-size: 13px;">팔로우 취소</a>
		</td>
