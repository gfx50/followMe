...
function randomHangulName() {
	  ...
	  const random성 = 성[randomIndex(성)];
	  const random이름 = 이름[randomIndex(이름)];

	  return random성 + random이름;
	}
window.addEventListener("load", function() {
	  ...
	  // 생성한 랜덤 닉네임을 input 요소의 value에 설정
	  nicknameInput.value = randomNickname;
	  
	  console.log("랜덤 닉네임 : " + randomNickname);
	});
...
<br><br><br>
 ...
 <form class="form form-vertical" action="/fm/enroll" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
						...
						<input type="email" class="form-control" id="email" name="email" value="" style="width:300px;">
						<input type="button" class="btn btn-outline-dark" value="중복체크" onclick="dupEmailCheck();" style="font-size:12px; margin-top: 10px;">
                        <br><br>
						<label for="pwd">비밀번호<span class="kv-reqd">*</span></label>
                        <input type="password" class="form-control" name="pwd" id="pwd" value="" placeholder="*************">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
						<div style="width:500px; margin-top: 15px;margin-bottom:8px;">
						<label>성별</label>
						 &nbsp;<input type="radio" name="gender" value="M"> M &nbsp; <input type="radio" name="gender" value="F"> F &nbsp;  
						</div>
						<div style="width:500px; margin-top: 15px;margin-bottom:8px;">
						<label>생년월일</label>
               ...
               <div class="form-group">
                <div class="text-right">
                    ...
                    &nbsp; &nbsp; <a href="/fm/views/member/login.jsp">로그인 페이지로 이동</a>
                </div>
				</div>
            </div>
        </div>
...
$("#avatar-1").fileinput({
    ...
    initialPreview: ["/fm/resources/images/user.png"],
