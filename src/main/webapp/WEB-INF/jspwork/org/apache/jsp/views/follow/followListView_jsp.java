 ...
 * Generated at: 2023-09-06 13:18:36 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.views.follow;
...
public final class followListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/follow/../common/head.jsp", Long.valueOf(1693643825518L));
    _jspx_dependants.put("/views/follow/../common/footer.jsp", Long.valueOf(1693144244000L));
    _jspx_dependants.put("/views/follow/../common/navbar.jsp", Long.valueOf(1694005937110L));
  }
...
ArrayList<Member> list2 = (ArrayList<Member>) request.getAttribute("list2");
	...
	Member loginMember = (Member)session.getAttribute("loginMember");
      ...
      out.write("	<br><br><br>\r\n");
      out.write("	\r\n");
      out.write("	<div class=\"bd-example container\" style=\"width:70%;\">\r\n");
      out.write("		 <br> <br> &nbsp; <span class=\"badge rounded-pill bg-dark\">팔로이</span><a style=\"margin-left:86%;\">");
      out.print( list.size() );
      out.write("명</a>\r\n");
      out.write("		<br><br>\r\n");
      ...
      out.write("            <th scope=\"col\"style=\"text-align: left;\">팔로우한 날짜</th>\r\n");
      out.write("            <th scope=\"col\" style=\"text-align: left;\">여부</th>\r\n");
      out.write("          </tr>\r\n");
      out.write("          </thead>\r\n");
      out.write("          <tbody>\r\n");
      out.write("          ");
if(list.isEmpty()){ 
      out.write("\r\n");
      out.write("          <tr>\r\n");
      out.write("          	<td>팔로이가 없습니다.</td>\r\n");
      out.write("          </tr>\r\n");
      out.write("          ");
 }for(Member m : list){ 
      out.write("\r\n");
      out.write("          <tr>\r\n");
      out.write("            <th scope=\"row\"><img src=\"/fm/resources/images/");
      out.print( m.getProfilePic()!=null?m.getProfilePic():"user.png" );
      out.write("\" \r\n");
      out.write("					style=\"width: 20px;height: 20px;object-fit: cover;border-radius:50%;\">&nbsp;<a href=\"/fm/info?mid=");
      out.print(m.getmId());
      out.write("\" style=\"font-weight: normal;text-decoration: none;color:black;\">");
      out.print( m.getEmail() );
      out.write("</a></th>\r\n");
      out.write("            <td style=\"text-align: left;\">");
      out.print( m.getFollowtime() );
      out.write("</td>\r\n");
      out.write("            <td style=\"text-align: left;\">\r\n");
      out.write("	    <a onclick=\"followdelete('");
      out.print( m.getmId() );
      out.write("');\" style=\"font-size: 13px;\">팔로우 취소</a>\r\n");
      out.write("		</td>\r\n");
      out.write("		<script type=\"text/javascript\">\r\n");
      out.write("	    function followdelete(mid) {\r\n");
      out.write("	        $.ajax({\r\n");
      out.write("	            type: 'POST',\r\n");
      out.write("	            url: '/fm/unfollow',\r\n");
      out.write("	            data: {\r\n");
      out.write("	                mid: mid\r\n");
      out.write("	            },\r\n");
      out.write("	            success: function(response) {\r\n");
      out.write("	                console.log('팔로우 취소 성공');\r\n");
      out.write("	                // 성공 시 추가로 수행할 작업을 여기에 추가할 수 있습니다.\r\n");
      out.write("	            },\r\n");
      out.write("	            error: function(xhr, textStatus, errorThrown) {\r\n");
      out.write("	                console.error('팔로우 취소 실패:', textStatus, errorThrown);\r\n");
      out.write("	                // 실패 시 처리할 작업을 여기에 추가할 수 있습니다.\r\n");
      out.write("	            }\r\n");
      out.write("	        });\r\n");
      out.write("	    }\r\n");
      out.write("	</script>\r\n");
      ...
      out.write("        </table>\r\n");
      out.write("        <br><br><br>\r\n");
      out.write("        &nbsp; <span class=\"badge rounded-pill bg-dark\">팔로워</span><a style=\"margin-left:86%;\">");
