 ...
 * Generated at: 2023-09-06 13:18:35 UTC
...
ArrayList<Message> list = (ArrayList<Message>) request.getAttribute("list");
      ...
      out.write("function showMessageWriteForm(){\r\n");
      out.write("	location.href = \"/fm/views/message/messageWriteForm.jsp?mid=");
      out.print(member.getmId());
      out.write("\";\r\n");
      out.write("}\r\n");
      out.write("function showsendMessageForm(){\r\n");
      out.write("	location.href = \"/fm/sendview?mid=");
      out.print(member.getmId());
      out.write("\";\r\n");
      out.write("	}\r\n");
      out.write("	function showMessageRepeatWriteForm() {\r\n");
      out.write("		location.href = \"/fm/rsend?mid=\" + $('#getmid').val();\r\n");
      out.write("	}\r\n");
      out.write("	function deleteMessage() {\r\n");
      out.write("		location.href = \"/fm/msgdelete?mid=\" + $('#getmid').val() + \"&content=\"\r\n");
      out.write("				+ $('#getcontent').val();\r\n");
      out.write("	}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
	...
	Member loginMember = (Member)session.getAttribute("loginMember");
      ...
      out.write("	<br>\r\n");
      out.write("	<br>\r\n");
      out.write("	<h1 align=\"center\">받은 메세지 목록</h1>\r\n");
      out.write("	");
	...
	if (member != null) {
      ...
      out.write("			onclick=\"showMessageWriteForm();\">메세지 보내기</button>\r\n");
      out.write("		&nbsp; &nbsp; &nbsp;\r\n");
      out.write("		<button class=\"btn btn-outline-secondary\"\r\n");
      out.write("			onclick=\"showsendMessageForm();\">보낸 메세지 보기</button>\r\n");
      out.write("	</div>\r\n");
      out.write("	<br>\r\n");
      out.write("	<br>\r\n");
      out.write("	<br>\r\n");
      out.write("	<table class=\"table table-striped container\" align=\"center\" border=\"1\"\r\n");
      out.write("		cellspacing=\"0\" width=\"900\">\r\n");
      out.write("		<tr>\r\n");
      out.write("			<th style=\"text-align: center;\">보낸사람</th>\r\n");
      out.write("			<th width=\"120\" style=\"text-align: center;\">날짜</th>\r\n");
      out.write("			<th style=\"text-align: center;\">확인</th>\r\n");
      out.write("		</tr>\r\n");
      out.write("		");
      ...
      out.write("\r\n");
      out.write("		<tr onclick=\"showToast('");
      out.print( m.getEmail() );
      out.write("', '");
      out.print( m.getMsgTime() );
      out.write("', '");
      out.print( m.getMsgContent() );
      out.write("', '");
      out.print( m.getmId() );
      out.write("', '");
      out.print( m.getRcvYN() );
      out.write("');\" style=\"cursor: pointer; height: 50px;\">\r\n");
      out.write("			<td align=\"center\"><img src=\"/fm/resources/images/");
      out.print( m.getProfilepic()!=null?m.getProfilepic():"user.png" );
      out.write("\" \r\n");
      ...
      out.write("					fill=\"currentColor\" class=\"bi bi-check2-square\" viewBox=\"0 0 16 16\">\r\n");
      out.write("  				<path\r\n");
      out.write("						d=\"M3 14.5A1.5 1.5 0 0 1 1.5 13V3A1.5 1.5 0 0 1 3 1.5h8a.5.5 0 0 1 0 1H3a.5.5 0 0 0-.5.5v10a.5.5 0 0 0 .5.5h10a.5.5 0 0 0 .5-.5V8a.5.5 0 0 1 1 0v5a1.5 1.5 0 0 1-1.5 1.5H3z\" />\r\n");
      out.write("  				<path\r\n");
      out.write("						d=\"m8.354 10.354 7-7a.5.5 0 0 0-.708-.708L8 9.293 5.354 6.646a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0z\" />\r\n");
      out.write("				</svg> ");
      ...
      out.write("			    style=\"margin: 0 auto; width: 500px; display: none; position: fixed; top: 30%; left: 40%;\">\r\n");
      out.write("			    <div class=\"toast fade show \" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\"\r\n");
      out.write("			        style=\"text-align: center; width: 500px; height: auto;\">\r\n");
      out.write("			        <div class=\"toast-header\">\r\n");
      out.write("			            <svg class=\"bd-placeholder-img rounded me-2\" width=\"20\" height=\"20\"\r\n");
      out.write("			                xmlns=\"http://www.w3.org/2000/svg\" aria-hidden=\"true\"\r\n");
      out.write("			                preserveAspectRatio=\"xMidYMid slice\" focusable=\"false\">\r\n");
      out.write("			                <rect width=\"100%\" height=\"100%\" fill=\"#007aff\"></rect>\r\n");
      out.write("			            </svg>\r\n");
      out.write("			\r\n");
      out.write("			            <a href=\"/fm/info?mid=");
      out.print(m.getmId());
      out.write("\" style=\"font-weight: normal;text-decoration: none;color:black;\"><strong class=\"me-auto\">");
      out.print(m.getEmail());
      out.write("</strong></a>\r\n");
      out.write("			             <small class=\"text-muted\" style=\"margin-left:auto;\">");
      out.print(m.getMsgTime());
      out.write("</small>\r\n");
      out.write("			            <button type=\"button\" class=\"btn-close\" onclick=\"displayToast()\"></button>\r\n");
      out.write("			        </div>\r\n");
      out.write("			        <div class=\"toast-body\" style=\"margin-bottom: 20px;\">");
      out.print(m.getMsgContent());
      out.write("</div>\r\n");
      out.write("			        <div style=\"text-align: center;\">\r\n");
      out.write("			            <button class=\"btn btn-outline-secondary\"\r\n");
      out.write("			                style=\"margin-right: 10px;margin-bottom:10px;\"\r\n");
      out.write("			                onclick=\"showMessageRepeatWriteForm();\">답장하기</button>\r\n");
      out.write("			            <button class=\"btn btn-outline-secondary\"\r\n");
      out.write("			                style=\"margin-left: 10px;margin-bottom:10px;\"\r\n");
      out.write("			                onclick=\"deleteMessage();\">삭제하기</button>\r\n");
      out.write("			        </div>\r\n");
      ...
      out.print(m.getMsgContent());
      out.write("\"\r\n");
      out.write("			            id=\"getcontent\"> <input type=\"hidden\"\r\n");
      out.write("			            value=\"");
      out.print(m.getRcvYN());
      out.write("\" id=\"getcheck\"> <input\r\n");
      out.write("			            type=\"hidden\" value=\"");
      out.print(m.getMsgId());
      out.write("\" id=\"getid\">\r\n");
      out.write("			    </div>\r\n");
      out.write("			</div>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("	<script>\r\n");
      out.write("	function showToast(email, msgTime, msgContent, mId, rcvYN) {\r\n");
      ...
      out.write("        $('.toast strong').text(email);\r\n");
      out.write("        $('.toast small').text(msgTime);\r\n");
      out.write("        $('.toast .toast-body').text(msgContent);\r\n");
      out.write("        $('#getmid').val(mId);\r\n");
      out.write("        $('#getcontent').val(msgContent);\r\n");
      out.write("        $('#getcheck').val(rcvYN);\r\n");
      out.write("    }\r\n");
      out.write("    $.ajax({\r\n");
      out.write("        url: \"/fm/check\",\r\n");
      out.write("        type: \"post\",\r\n");
      out.write("        data: {\r\n");
      out.write("            mid: mId,\r\n");
      out.write("            content: msgContent,\r\n");
      out.write("            check: rcvYN\r\n");
      out.write("        },\r\n");
	...
	if (member == null) {
      ...
      out.write("	<br>\r\n");
      out.write("	<br>\r\n");
      out.write("	<h6 align=\"center\">먼저 로그인해주세요</h6>\r\n");
      out.write("	<br>\r\n");
      out.write("	<br>\r\n");
      out.write("	");
 } 
