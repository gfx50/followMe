...
/**
 * Servlet implementation class WeeklyMaxFootprintServlet
 */
@WebServlet("/weeklygood")
public class WeeklyMaxFootprintServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public WeeklyMaxFootprintServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 주간 좋아요순 순위
		ArrayList<Trail> list = new SearchService().selectWeeklyBestTrail();
