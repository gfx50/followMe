...
/**
 * Servlet implementation class TrailCountSearchServlet
 */
@WebServlet("/tcount")
public class TrailCountSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TrailCountSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 조회수 별 게시물 불러오기
		ArrayList<Trail> list = tservice.selectCountList();
