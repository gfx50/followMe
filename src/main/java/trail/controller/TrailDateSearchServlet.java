...
/**
 * Servlet implementation class TrailDateSearchServlet
 */
@WebServlet("/tdate")
public class TrailDateSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public TrailDateSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 날짜 최근순 게시물 불러오기
		ArrayList<Trail> list = tservice.selectDateList();
